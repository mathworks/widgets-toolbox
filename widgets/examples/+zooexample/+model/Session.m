...
%   Copyright 2025 The MathWorks Inc.
    ...
    properties (SetObservable)
        ...
        Exhibit (:,1) zooexample.model.Exhibit
    ...
    methods
        ...
        function importManifest(session, filePath)
            ...
            arguments
                session (1,1) zooexample.model.Session
            ...
            % Preallocate output
            animal(numRows,1) = zooexample.model.Animal;
            ...
            % Preallocate output
            enclosure(numRows,1) = zooexample.model.Enclosure;
            ...
            % Preallocate output
            exhibit(numRows,1) = zooexample.model.Exhibit;
