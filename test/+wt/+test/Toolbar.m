classdef Toolbar < wt.test.BaseWidgetTest
    ...
    methods (Test)
        ...
        function testHorizontalSection(testCase)
            ...
            % Add buttons
            openButton = testCase.verifyAddButton(section,"Open","open_24.png");
            saveButton = testCase.verifyAddButton(section,"Save","save_24.png");
        ...
        function testVerticalSection(testCase)
            ...
            % Add buttons
            openButton = testCase.verifyAddButton(sectionV,"Open","open_24.png");
            saveButton = testCase.verifyAddButton(sectionV,"Save","save_24.png");
